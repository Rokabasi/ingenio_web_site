...
const sizeConfig = {
  header: {
    plate: "px-2 py-1.5 sm:px-2.5 sm:py-2",
    image: "h-8 w-auto max-w-[148px] sm:h-10 sm:max-w-[168px]",
  },
  footer: {
    plate: "px-2.5 py-2 sm:px-3 sm:py-2.5",
    image: "h-10 w-auto max-w-[180px] sm:h-12 sm:max-w-[200px]",
  },
} as const;
